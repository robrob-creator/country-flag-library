...
export const DM = ({ width, height, className, style }: LogoProps) => {
  return (
    <svg
    ...
    >
      ...
      <g fill="#006b3f" transform="translate(600 300)">
        ...
        <use height="100%" transform="rotate(36)" width="100%" xlinkHref="#b" />
        <use height="100%" transform="rotate(72)" width="100%" xlinkHref="#b" />
        <use
          height="100%"
