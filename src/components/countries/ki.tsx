...
export const KI = ({ width, height, className }: LogoProps) => {
  return (
    <svg
    ...
    >
      ...
      >
        <g id="rays_6">
          <g id="rays_2" transform="rotate(-84.706 300 156)">
            ...
            />
            <path id="straight" d="M290.63 105.87L300 63l9.37 42.87" />
          </g>
          <use xlinkHref="#rays_2" transform="rotate(21.18 300 156)" />
          <use xlinkHref="#rays_2" transform="rotate(42.35 300 156)" />
        </g>
        <use xlinkHref="#rays_6" transform="rotate(63.53 300 156)" />
        <use xlinkHref="#rays_6" transform="rotate(127.06 300 156)" />
      ...
      <path
        ...
        id="wave"
      />
      <use xlinkHref="#wave" y="48" />
      <use xlinkHref="#wave" y="96" />
    </svg>
  );
};
