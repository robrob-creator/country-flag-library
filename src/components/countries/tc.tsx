...
export const TC = ({ width, height, className }: LogoProps) => {
  return (
    <svg
      ...
      <g transform="translate(7200 2400)" fill="none" stroke="#000">
        ...
        <g stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <g transform="translate(400 -400)" fill="#9e540a">
            ...
            <use transform="scale(-1 1)" xlinkHref="#d" />
            <g id="e">
            ...
            <use transform="scale(-1 1)" xlinkHref="#e" />
          </g>
          <g id="f">
            <path
              fill="#009e49"
          ...
          <use transform="scale(-1 1)" xlinkHref="#f" />
