...
export const SM = ({ width, height, className }: LogoProps) => {
  return (
    <svg
      ...
      className={className}
    >
      <path fill="#62B5E5" d="M0 0h800v600H0z" />
      ...
      <g fill="none" stroke="#000" stroke-width=".93">
        ...
        <g fill="#000" stroke-linecap="round" stroke-linejoin="round">
          ...
          <path
            fill="#EAAA00"
            d="M442.33 171.3c.36.68.9 1.86 1.25 3.34 6.25-7.44 10.92-15.14 6-21.5-4.47-5.8-15.45-3.18-26.88-7.2a29.75 29.75 0 01-14.74-9.49c.42 1.13.86 2.5 1.34 3.88 11.6 14.77 34.76 7.7 39.17 15.76 2.6 4.77-1.1 10.26-6.14 15.22z"
            stroke="none"
          />
          <path
            d="M448.05 170.6c-1.5-.37-2.25-1.03-3.23-1.93-.3.35-.6.69-.92 1.02a8.3 8.3 0 002.46 1.8c.92.4 1.9.56 2.82.6.34-.45.68-.9 1-1.36a7.4 7.4 0 01-2.13-.13zm2.81-6.4a5.99 5.99 0 01-2.5-.8c-.15.35-.32.7-.51 1.04.76.44 1.38.7 2.43.92 1.05.22 2.15.15 3.12-.01l.58-1.34c-.95.19-2.18.35-3.12.2zm-1.54-4.8a8.77 8.77 0 005.5-2.83 8.6 8.6 0 00-.4-1.22c-.8 1.01-2.57 2.77-5.18 3 .05.34.08.7.08 1.04zm-1.8-4.56a8.94 8.94 0 003.45-3.77c-.27-.2-.56-.38-.86-.55a7.64 7.64 0 01-3.4 3.65c.3.2.56.43.8.67zm-3.99-6.15c-.24 1.4-.99 2.6-2.14 3.45l1.11.26a6.26 6.26 0 001.93-3.58l-.9-.13zm-7.1-.62a5.93 5.93 0 01-2.09 2.7.44.44 0 00-.18.3l1.1.13c1-.84 1.75-1.89 2.11-3.06l-.94-.07zm-6.92-.69a8.14 8.14 0 01-2.68 2.55l1.27.25a8.9 8.9 0 002.4-2.67l-.99-.13zm-6.19-1.26c-.9.87-2.03 1.51-3.24 1.92.43.17.87.32 1.3.47a8.96 8.96 0 002.95-2.12c-.34-.08-.67-.17-1-.27zm-6.23-2.39c-.82.6-1.92 1-2.9 1.24.34.23.67.45 1.01.66 1-.32 2.02-.79 2.8-1.46l-.9-.44zm-4.59-2.9a9.3 9.3 0 01-2.18.72c.24.26.48.52.73.76a8.8 8.8 0 002.25-.9c-.27-.18-.53-.38-.8-.59z"
            stroke="none"
          />
          <path
            fill="none"
        ...
        <path
          fill="#EAAA00"
          d="M389.98 144.4c.43-.14.88-.25 1.32-.25 1.5 0 2.09.98 2.09.98s3.93-.9 6.69-.9c2.76 0 6.69.9 6.69.9s.6-.98 2.1-.98c.38 0 .77.08 1.16.2.02.46.02.91-.02 1.35-.32 3.66-2.6 6.45-3.3 10.06a29.12 29.12 0 00-.22 7.05l-6.41 3.05-6.42-3.05c.16-2.17.2-4.86-.22-7.05-.69-3.6-3.12-6.4-3.45-10.06a9.12 9.12 0 01-.01-1.3z"
          stroke="none"
        />
        <path
          fill="#000"
          d="M407.1 146.81c-.3.95-.79 2.46-1.2 3.98a21.98 21.98 0 00-.82 4.04c-.19 3.87.47 8.07 1.24 11.87h-.27c-1.1-3.32-2.35-8.43-2.3-11.87.03-2.1 1.35-6.15 2.03-8.1.98-2.8.78-4.7.09-6.57-.7-1.88-1.87-3.75-2.84-6.5v-.04h1.3c.99 2.7 2.1 4.59 2.76 6.5a9.8 9.8 0 010 6.7zm-13.26 19.89c.78-3.83 1.42-7.97 1.25-11.86-.05-1-.4-2.53-.82-4.05-.42-1.52-.9-3.03-1.2-3.97-.88-2.81-.18-6.14.75-8.75.8-2.27 1.77-4.02 2.02-4.45h1.34c-.4.68-4.64 7.83-2.8 13.12.68 1.94 2 6 2.04 8.09.04 3.43-1.22 8.55-2.3 11.87h-.28z"
          stroke="none"
        />
        ...
        <path
          stroke-width=".9"
          d="M360.41 204.28s-1.05-1.06-1.37-1.93c-.26-.69-.28-1.86-.28-1.86l-3.79-6.07 8.5-8.09 16.18-4.64 20.4-1.46h.03l20.4 1.46 16.17 4.64 8.5 8.1-3.78 6.06s-.02 1.17-.28 1.86a7.2 7.2 0 01-1.38 1.93l-18.97-6.41-20.66-.93-20.7.93-18.97 6.41z"
        />
        <path
          fill="#F1C400"
        ...
        <path
          fill="#000"
          d="M358.83 207.29a41.17 12.78 0 1182.34 0 41.17 10.82 0 11-82.34 0z"
        />
        <path
          fill="#F1C400"
          d="M360.2 207.29a39.8 12.31 0 1179.6 0 39.8 10.52 0 11-79.6 0z"
        />
        <ellipse fill="#EAAA00" cx="400" cy="208.41" rx="36.78" ry="9.39" />
        <path
          stroke-width="1.09"
        ...
        <g stroke-width=".78" stroke-linecap="round" stroke-linejoin="round">
          ...
          <path
            fill="#F1C400"
            d="M359.49 195.08a2.39 2.39 0 01-3.03 3.62 2.87 2.87 0 01-.14-.53c-.3-1.65.97-3.14 2.07-3.34l.24-.02c.3 0 .59.1.86.27z"
            stroke="none"
          />
          ...
          <path
            fill="#F1C400"
            d="M385.72 189a1.5 1.5 0 113-.26 1.5 1.5 0 01-3 .26zm-3.48 3.33a1.5 1.5 0 113-.26 1.5 1.5 0 01-3 .26zm-3.55-2.67a1.5 1.5 0 011.36-1.63c.83-.07 1.41.54 1.48 1.37.07.82-.39 1.55-1.21 1.63a1.5 1.5 0 01-1.63-1.37zm3.03-3.33a1.5 1.5 0 113-.25 1.5 1.5 0 01-3 .25z"
            stroke="none"
          />
          <path
            fill="#EAAA00"
            d="M385.81 189.4a1.5 1.5 0 012.82 0 1.5 1.5 0 01-2.82 0zm-4-2.67a1.5 1.5 0 002.81 0 1.5 1.5 0 00-2.81 0zm-3.03 3.32a1.5 1.5 0 001.54.98 1.3 1.3 0 001.14-.95c-.18-.63-.7-1.06-1.4-1a1.5 1.5 0 00-1.28.97zm3.55 2.67a1.5 1.5 0 002.82 0 1.5 1.5 0 00-2.82 0z"
            stroke="none"
          />
          <path
            stroke-width=".93"
          ...
          <path
            fill="#F1C400"
            d="M414.37 189a1.5 1.5 0 10-2.99-.26 1.5 1.5 0 003 .26zm3.49 3.33a1.5 1.5 0 10-3-.26 1.5 1.5 0 003 .26zm3.55-2.67a1.5 1.5 0 00-1.36-1.63c-.83-.07-1.41.54-1.48 1.37-.08.82.39 1.55 1.21 1.63a1.5 1.5 0 001.63-1.37zm-3.03-3.33a1.5 1.5 0 10-3-.25 1.5 1.5 0 003 .25z"
            stroke="none"
          />
          <path
            fill="#EAAA00"
            d="M414.29 189.4a1.5 1.5 0 00-2.82 0 1.5 1.5 0 002.81 0zm1.18-2.67a1.5 1.5 0 002.82 0 1.5 1.5 0 00-2.82 0zm3.17 3.35c.15.51.56.9 1.14.95a1.5 1.5 0 001.54-.98 1.5 1.5 0 00-1.28-.97c-.7-.06-1.21.37-1.4 1zm-3.7 2.64a1.5 1.5 0 002.83 0 1.5 1.5 0 00-2.82 0z"
            stroke="none"
          />
          <path
            stroke-width=".93"
          ...
          <path
            fill="#F1C400"
            d="M439.95 196.63c0-.6.22-1.13.57-1.55a1.62 1.62 0 011.1-.25c1.1.2 2.36 1.69 2.07 3.34-.03.18-.08.36-.14.53a2.39 2.39 0 01-3.6-2.07z"
            stroke="none"
          />
        ...
        <g stroke-linejoin="round" stroke-linecap="round">
          ...
          <path
            fill="#F1C400"
            d="M397.49 91.5c-.2-.24-.36-.51-.46-.8a3.3 3.3 0 013.05-2.37c.61 0 1.2.2 1.7.54-.1.36-.92.43-1.68 1.08-1.1.91-1.69 2.66-2.61 1.56zm.5 5.1c.15.2.22.41.22.64 0 1.1-1.9 1.98-4.24 1.98-1.96 0-3.62-.62-4.1-1.47a3.25 3.25 0 012.7-1.47c1.63 0 3.87 1.39 5.03.67.16-.1.3-.22.4-.35zm3.27.17c0-.51.25-1 .67-1.4-.1.63.02 1.18.64 1.58 1.1.72 3.33-.67 5.03-.67 1.07 0 2.09.57 2.66 1.43-.65 1.04-2.36 1.78-4.36 1.78-2.56 0-4.64-1.22-4.64-2.72z"
            stroke="none"
          />
      ...
      <g stroke-width=".93" stroke-linejoin="round" stroke-linecap="round">
        ...
        <path
          fill="#789D4A"
          d="M421.68 348.39a28.54 28.54 0 0113.95-3.62c8.24 0 15.66 3.47 20.9 9.03-20.6 37.02-56.48 52.66-56.48 52.66s-34.96-14.75-55.66-52.83a28.59 28.59 0 0120.73-8.86c5.67 0 10.97 1.65 15.42 4.5a28.59 28.59 0 0121-9.15c7.85 0 14.96 3.15 20.14 8.27z"
        />
        <path
          fill="#4A783C"
        ...
        />
        <path d="M422.07 347.94c1.89 1.78 2.7 3.26 2.72 3.28.18.3-.03.99-.57.48 0 0-.75-.71-2.95-2.86-2.96-2.9-8.1-6.55-12.34-7.26-.4-.07-.58-.27-.53-.57a.6.6 0 01.7-.5c.09 0 6.35 1.18 12.97 7.43zm-34.87 5.56c.2.17.24.41.14.6-.12.18-.36.22-.56.07-3.59-2.55-5.34-3.61-7.42-4.92-.16-.1-.27-.27-.15-.46.08-.12.25-.2.41-.24.33-.1.82-.11 1.14.08a58.08 58.08 0 016.44 4.87z" />
        <path
          fill="none"
          stroke="#000"
          stroke-width="1.24"
          d="M421.68 348.39c4.13-2.3 8.89-4.09 13.95-4.09 8.28 0 15.74 3.64 20.97 9.37m-112.31-.23a28.28 28.28 0 0120.83-9.3c5.68 0 10.97 2.28 15.42 5.13 5.24-5.63 12.7-9.77 21-9.77 7.85 0 14.96 3.77 20.14 8.89"
        />
        <path
          fill="none"
          stroke="#41748D"
        ...
        <g fill="none">
          ...
          <path
            fill="#fff"
            d="M373.24 333.22l3.4 13.95a28.59 28.59 0 00-11.52-2.4l-.73-57.57 3.1.9v6.05l3.87 1v-6l5.27 1.38v9.85l-3.4 5.03v27.81z"
          />
          <path
            fill="#BBBCBC"
            d="M364.39 332.15V287.2l-3.1 1.35v5.96l-3.88 1.55v-6l-5.27 2.25v9.53l3.79 4.54.09 27.4-3.88 14.08a28.53 28.53 0 0112.25-3.1v-12.62z"
          />
          <path
            stroke="#000"
            stroke-width="1.09"
        ...
        <g fill="none">
          ...
          <path
            fill="#fff"
            d="M408.1 328.1l3.4 13.8a28.58 28.58 0 00-12.38-1.68l.14-58.44 3.1 1.04v6.06l3.87 1.07v-5.92l5.27 1.7v9.81l-3.4 4.84v27.73z"
          />
          <path
            fill="#BBBCBC"
        ...
        <g fill="none">
          ...
          <path
            fill="#fff"
            d="M442.98 333.53l3.4 13.32A28.59 28.59 0 00434 344.8l.13-57.6 3.1 1.04v6.05l3.87 1.3v-5.91l5.27 1.77v9.7l-3.4 4.8v27.57z"
          />
          <path
            fill="#BBBCBC"
            d="M434.13 332.15V287.2l-3.1.96v6.05l-3.87 1.15v-5.99l-5.27 1.7v9.76l3.78 4.85.1 27.55-3.88 15.03a28.5 28.5 0 0112.24-3.46v-12.66z"
          />
          <path
            stroke="#000"
            stroke-width="1.09"
        ...
        <g id="a" stroke="#000">
          ...
          <path
            fill="#fff"
            d="M369.85 267.53c-.65-2.87-2.23-6.61-5.84-5.97l-.24.31c.17 4.8 6.2 19.42.46 22-.15-8.37-7.7-13.8-5.76-21.64.54-2.18 2.7-4.88 4.81-5.67a8.85 8.85 0 013.2-.66c7.25.15 9.14 7.67 3.37 11.63z"
          />
          <path
            stroke="none"
          ...
          <path
            stroke="none"
            d="M369.14 259.6c-2.23-3.3-7.83-1.44-9.28.64-.1.15-.47-.08-.68-.16a.47.47 0 01-.08-.04c.39-.65.87-1.3 1.43-1.88 2.71-1.74 7.43-2.09 9.33.98.15.24.05.48-.13.58-.18.11-.44.1-.6-.13z"
          />
        </g>
        <use xlinkHref="#a" x="35.34" y="-5.42" />
        <use xlinkHref="#a" x="70.67" />
        <g stroke="#000">
          <path d="M446.26 240.53c3.26 2.16 14.8 8.65 16.52 45.64 3.33 72.1-58.02 114.16-58.02 114.16s77.62-33.05 77.62-114.23c0-34.17-13.56-71.19-40.47-71.19l-14.8.05L405.64 225a6.78 6.78 0 00-5.35-2.6 6.79 6.79 0 00-5.35 2.6l-21.48-10.05-15.26-.05c-26.9 0-40.48 37.02-40.48 71.2 0 81.17 77.63 114.22 77.63 114.22S334 358.25 337.33 286.16c1.7-37 13.25-43.48 16.52-45.64l18.13 6.05 22.91-13.41c1.5 1.6 3.04 2.73 5.4 2.73 2.36 0 3.68-.93 5.4-2.73l22.76 13.57z" />
          <path
            fill="#EAAA00"
          ...
          <path
            fill="none"
            d="M394.13 227.78a6.31 6.31 0 0112-1.02m.33 4.06a6.38 6.38 0 01-12.1.7m7.55 1.62a4.23 4.23 0 01-5.86-3.74m7.87 2a4.24 4.24 0 01-2 1.74m-1.2-1.9a2.05 2.05 0 01-2.48-1.8m-2.12-1.23c.13-.56.37-.9.47-1.05"
          />
          <path
            fill="none"
      ...
      >
        ...
        <path
          fill="none"
          stroke-width=".78"
          d="M284.54 262.68c.07-.3.02-.64-.16-1.07-.18-.44-.47-.92-.77-1.42-.3-.52-.64-1.08-.9-1.65a5.41 5.41 0 01-.5-1.87l1.4-.4a6.8 6.8 0 002.17 3.74l.43.45-1.18 2.62c-.08.2-.6 0-.5-.4z"
        />
        <path
          stroke-width=".78"
        ...
        <path
          fill="#2C5234"
          d="M315.48 368.9c-.4-2.88-3.7-7.05-5.07-9.74a36.3 36.3 0 01-3.98-12.68c-.97-9.54 1.21-14.68 7.5-21.75.04 2.07.31 2.8.94 4.72 2.63 8.1 6.3 14.78 5.11 23.58-.59 4.33-4.12 10.5-4.28 13.14-.09 1.38.69 2.98 1.37 4.14l-1.6-1.4z"
        />
        ...
        <path
          fill="#4A783C"
          d="M281.96 336.01c-3.62-1.15-7.78-1.85-12.2-2.91-4.14-1-7.52-3.26-10.68-6.1-4.9-4.42-6.51-10.35-7.47-16.7a48.74 48.74 0 01-.44-10.62c.4.7.9 1.38 1.55 1.85 3.21 2.3 6.56 3.9 9.78 6.23 2.81 2.04 4.81 3.38 7.12 5.98a54.2 54.2 0 017.4 10.73c1.62 3.07 3 6.66 5.1 9.44z"
        />
        <path
          fill="#8F6A2A"
          d="M282.12 333.91c1.08 1.45 5.45 3.32 7.05 3.53l1.54 3.85c-2.27-2.65-5.26-4.17-8.75-5.28z"
        />
        <circle fill="#EAAA00" cx="271.96" cy="304.79" r="4.42" />
        <path
          fill="#F1C400"
          d="M272.47 300.88a4.54 4.54 0 00-.36 1.78c0 1.94 1.15 3.53 2.56 3.53.4 0 .76-.13 1.1-.35a3.95 3.95 0 00-3.3-4.97z"
          stroke="none"
        />
        <circle
          fill="none"
        ...
        />
        <path d="M285.72 329.93c-1.23-1.18-3.01-2.3-4.2-3.54-11.02-11.44-8.13-31.44 3.97-41.2.41-.33.72-.18.78.31a51.95 51.95 0 002.73 12.26c3.69 10.13 4.29 15.94.94 24.57-2.05 5.26 0 9.9 0 9.9l-4.22-2.3z" />
        <path
          stroke-width=".62"
        ...
        />
        <path d="M294.87 341.94l.01-.17c1.64-1.95.5-7.82-.03-10.17a28.63 28.63 0 01-.37-11.68c.78-4.76 3.4-9.07 6.07-13.02 1.2-1.76 5.07-7.26 5.47-9.25.03-.17.21-.16.29 0 1.48 3.23 2.25 7.16 2.85 10.64.83 4.88 1.1 9.31-.6 14.86a27.2 27.2 0 01-6.68 11.52c-1.32 1.42-4.42 4.53-4.88 6.2-.08.32-.6 2.56-.5 4.2l-1.63-3.13z" />
        <path
          stroke-width=".95"
          d="M283.94 277.75s.2.03 1.1-.56a6.28 6.28 0 002.4-2.89c.46-1.27 3.65-11.86 7.9-18.41 4.98-7.66 10.14-11.1 16.4-16.72.98 6.07 1.13 15.96-4 23.9-4.7 7.27-16.61 12.44-18 12.98-1.38.54-3.74.94-5.1 2.75-.77 1.02-1.3 3-1.3 3l.6-4.05z"
        />
        ...
        <path
          fill="#4A783C"
          stroke-width=".95"
          d="M284 279.97l.22-1.97a6.82 6.82 0 003.52-3.6c2.66-6.38 4.29-12.87 8.04-18.76 4.86-7.66 10.07-10.64 15.33-14.84.25 6.76 1.44 13.89-3.95 22.76-3.06 5.03-11.98 10.02-17.53 12.2-2.48.99-4.26 1.78-5.63 4.21z"
        />
        ...
        <path
          fill="#4A783C"
          d="M282.06 278.96l-.78 2.5c-.44-3.25-1.8-4.7-4.14-6.81-10.18-9.21-14.53-20.05-10.26-32.73a25.31 25.31 0 016.08-10.33 50.61 50.61 0 014.34 9.15c3.49 9.38 4.88 14.69 3.5 25.44-.5 3.8-2.32 8.42.2 11.8.28.36.62.8 1.06.98z"
          stroke="none"
        />
        <path
          fill="none"
        ...
        />
        <circle fill="#EAAA00" cx="281.44" cy="253.51" r="4.42" stroke="none" />
        <path
          fill="#F1C400"
        ...
        <circle
          ...
          r="4.61"
        />
        <circle fill="#EAAA00" cx="303.96" cy="344.42" r="4.57" stroke="none" />
        <path
          fill="#F1C400"
        ...
        <path
          fill="none"
          d="M406.8 432.55s.05-1.39 1.69-1.78a1.8 1.8 0 012.08.93m7.23 15.61c-2.99.62-4.81-3.13-3.79-4.05.67-.6 2.32-.48 3.54.12 2.16 1.05 1.58 3.66.25 3.93z"
        />
        <path
          fill="#8F6A2A"
        ...
        <path
          stroke-width=".45"
          d="M328.64 380c-5.59-3.52-13.44-8.75-20.53-16.02a151 151 0 01-5.91-6.67s2.83 4.42 5.14 6.82c6.31 6.58 14.99 12.74 20.57 16.25l.73-.39zm19.33 6.7s-10.5-7.53-15.23-14.11a44.67 44.67 0 01-5.56-9.83 51.9 51.9 0 006.33 9.83c4.73 5.99 14.46 13.18 14.46 13.18v.93zm-52.02 13.51c15.45-2.15 21.46-11.17 34.61-13.22-1.38.07-1.13-.47-2.39-.2-11.6 2.44-18.7 11.22-32.22 13.42z"
        />
        <circle fill="#EAAA00" cx="314.8" cy="382.21" r="4.57" stroke="none" />
        <path
          fill="#F1C400"
          d="M319.29 381.34c-.04.15-.1.3-.18.43-.67 1.16-2.5 1.35-4.1.43-1.6-.92-2.34-2.6-1.67-3.76.19-.34.47-.59.82-.76a4.57 4.57 0 015.12 3.66z"
          stroke="none"
        />
        ...
        <path
          fill="#F1C400"
          d="M338.15 397.95c-1.46.56-3.39-.4-4.47-2.27-1.17-2.03-.92-4.37.57-5.23l.06-.03.37-.02a4.57 4.57 0 013.47 7.55z"
          stroke="none"
        />
        ...
        <path
          fill="#4A783C"
          d="M289 333.47c-1.65-2.52-5.16-5.34-7.14-7.4a22.64 22.64 0 01-6.31-12.5c-1.84-11.54 1.52-19.3 9.94-27.1.54 8.1 5.17 14.8 6.15 22.9 1.4 11.6-5.98 13.79-.85 25.14l-1.78-1.04z"
          stroke="none"
        />
        <path
          fill="#8F6A2A"
        ...
        <path
          fill="none"
          d="M289 333.47c-1.65-2.52-5.16-5.34-7.14-7.4a22.64 22.64 0 01-6.31-12.5c-1.84-11.54 1.52-19.3 9.94-27.1.54 8.1 5.17 14.8 6.15 22.9 1.4 11.6-5.98 13.79-.85 25.14"
        />
        <path
          stroke-width=".45"
      ...
      >
        <path
          stroke-width=".78"
          d="M514.67 257.68a.63.63 0 01.04-.27s.3-.43.6-1.14c.3-.73.61-1.73.63-2.84l1.66.34c-1.39 4.94-1.44 6.7-1.44 6.7-.01.4-.49.47-.6.08l-.9-2.87z"
        />
        ...
        <path
          stroke-width=".78"
          d="M519.6 286.9c0-.05.06-.23.09-.27 0 0 1.27-1.34 2.03-2.2.3-.33.48-.73.6-1.06.1-.32.13-.55.13-.55.03-.2.2-.32.4-.25l2.18.72c.3.1.33.36.08.54-.02.01-1.67 1.18-2.27 1.9a9.15 9.15 0 00-2.2 3.8c-.12.37-.53.34-.6-.06l-.43-2.57z"
        />
        <path
          fill="#8F6A2A"
          stroke-width=".78"
        ...
        <path
          stroke-width=".45"
          d="M521.66 307.03c.23-.07 9.06-7.1 14.02-12.49 4.07-4.4 9.46-12.12 9.46-12.12s-5.33 7.86-9.3 12.43a144.33 144.33 0 01-14.18 13.57c-.24.07-.24-1.33 0-1.4z"
        />
        ...
        <path
          fill="#F1C400"
          d="M531.9 271.84a3.83 3.83 0 00-.88 2.6c0 1.68.84 3.06 1.89 3.1.14-.45.27-.93.37-1.43.17-.86.26-1.73.19-2.44-.07-.7-.29-1.2-.58-1.45l-.01-.02a1.8 1.8 0 00-.97-.36h-.02z"
          stroke="none"
        />
        <path
          stroke-width=".86"
        ...
        <path d="M490.57 336.03a10.1 10.1 0 012.42-2.34c1.27-.96 4.48-2.68 5.9-1.3 1.86 1.8 2.76 7.23.6 9.12-2.85 2.5-7.47-.37-9.26-2.84-.62-.85-.17-1.87.34-2.64z" />
        <path
          fill="#8F6A2A"
        ...
        <path
          fill="#F1C400"
          d="M490.64 329.5c-.47.03-.84.16-1.06.36a.83.83 0 00-.11.23c.78.39 2.18.74 3.6 1.38 2.05.9 3.47 2.1 4.07 1.76.1-.33.1-.59.03-.71a4.58 4.58 0 00-1.28-1.2c-.65-.44-1.47-.88-2.31-1.21a8.5 8.5 0 00-2.44-.61 3.77 3.77 0 00-.5 0z"
          stroke="none"
        />
        <path
          fill="#2C5234"
        ...
        <path
          fill="#F1C400"
          d="M469.06 394.48l-.14.04c-1.5.31-2.34 2.27-1.89 4.39.2.94.63 1.76 1.17 2.34h.02c1.3.1 2.44-.15 2.86-.66.52-.62.49-1.68.01-2.9a11.36 11.36 0 00-2.03-3.2z"
          stroke="none"
        />
        <path
          fill="#8F6A2A"
          stroke-width=".78"
          d="M515.85 260.45s.05-1.77 1.45-6.76c.24-.87.9-1.35.9-1.35l-2.6-.36s.66.63.65 1.46a8.31 8.31 0 01-1.29 4.15l.89 2.86z"
        />
        <path
          fill="#4A783C"
          stroke-width=".85"
        ...
        <path
          fill="#4A783C"
          d="M491.45 372.43c2.67.75 2.74 4.86 4.28 5.24 1.54.39 1.5-.42 2.46-.2.89.2 1.78 5.39 6.08 4.85 1.1-.13 1.64-1.3 1.64-1.3s1.58 2.58 3.23 2.81c2.38.34 1.7-1.8 2.3-1.88.97-.1 2.74 1.94 4.52 1.94 1 0 .85-1.7 1.91-1.7s3.14 1 4-.24c1.13-1.61-1.49-3.5-1.68-4.08-.2-.58.74-.6.65-1.15-.37-2.05-3.7-2.38-4-3.1-.28-.73.47-1.47.2-2.6-.48-1.91-3.2-1.98-4.43-1.7-2.85.63-.27-2.41-2.3-3.27-3.49-1.47-8.57 1.32-9.86.77a7.38 7.38 0 00-1.95-.6c-3.15-.55-6.05 4.04-8.04 5l1 1.2z"
        />
        <path
          stroke-width=".45"
        ...
        <path
          fill="#4A783C"
          d="M441.42 390.86s8.2-3.43 8.87-5.15c1.04-2.64-.09-6.63 1.35-7.59.93-.62 1.87-.31 2.49-1.2.61-.89-.19-5.2 2.03-6.93 1.4-1.1 2.64-.12 4.34-1.3 1.82-1.3-.48-4.47 2.3-5.5 1.64-.62 3.3 1.38 4.11 1.17 1.57-.4 2.4-3.54 4.7-3.2 1.86.27.95 2.15.84 3.94-.07 1.02 1.54.55 2.01 1.99.35 1.04-1.08 3.3-2.03 4.13-.55.48 1.66 1.31 1.53 2.8-.2 2.14-4.32 2.29-5.27 2.63-1.24.44-.13 2.29-.96 3.36-1.35 1.72-4.78.65-5.4 1.47-.56.75.69 2.68-.89 3.87-1.64 1.23-8.01.45-9.05.83a77.2 77.2 0 00-5.57 2.31l-5.4 2.37z"
        />
        <path
          stroke-width=".45"
        ...
        <path
          fill="#8F6A2A"
          d="M512.96 250.46c1.09 2.7 2.64 6.9 3.67 10.8 4.84 18.34 5.28 39.53 3.21 51.77-6.38 37.7-40.66 72.78-68.1 78.26-23.3 4.65-37.07 14.75-46.85 25.54a92.49 92.49 0 00-11.2 15.07c-2.84 4.82-4.7 8.96-7.23 13.1l-.14.06c-.17.07-.4.12-.66.17-.55.1-1.26.18-1.92.21a6.6 6.6 0 01-1.65-.09l-.08-.02 1.05-1.65c2.4-3.97 4.5-7.84 7.25-12.43a94.37 94.37 0 0110.4-14.4c10.18-11.5 24.64-22.62 49.35-27.6 28.78-5.77 61.63-41.45 68.07-79.47 2.09-12.39 2.04-33.76-5.82-56.93l.65-2.4z"
        />
        <path
          stroke-width=".45"
          d="M511.84 248.25a78.38 78.38 0 00-7.52-14.97c-4.46-7.16-13.52-16.88-13.52-16.88s8.57 9.76 12.8 16.85a80.72 80.72 0 019.06 20.47l-.82-5.47z"
        />
        <path
          fill="#8F6A2A"
          d="M513.23 254.08s-.36-.9-.55-1.5c-.4-1.24-.71-3.27-.71-3.27l.98 2.35a51 51 0 01.9 2.46l-.62-.04z"
          stroke="none"
        />
        ...
        <path
          fill="#F1C400"
          d="M491.36 377.72c-.28.12-.53.27-.74.5-1.02 1.13-.54 3.23 1.07 4.67a4.8 4.8 0 002.64 1.25h.01c.22-.15.38-.32.46-.48.35-.75-.03-2.1-.94-3.41-.68-.98-1.61-1.9-2.5-2.53z"
          stroke="none"
        />
        ...
        <path
          fill="#F1C400"
          d="M519.86 239.27c-.07 0-.16.02-.25.04.1.66.51 1.62.7 2.72.25 1.46.22 3.85 1.24 3.67.63-.1.9-.6.9-1.57v-.02a9.46 9.46 0 00-.6-2.64c-.53-1.32-1.35-2.13-1.8-2.2h-.2z"
          stroke="none"
        />
        <path
          fill="none"
